...
#removal of the biological effects
drops<-c( "Cytotoxicity" ,        
          "Neurological.effects",  "Pulmonary.effects",     "Fibrosis",              "RCNS.effects",          "Immunological.effects", "Genotoxicity" ,        
          "Inflammation"     )
...
bnlearn::arcs(ug, check.cycles = TRUE) = matrix(c( "Shape","NM.Hazard", "Nanoparticle", "NM.Hazard","Surface.area",
                                                   
                                                   "NM.Hazard",  "Surface.charge", "NM.Hazard",
                                                   
                                                   "Dissolution", "NM.Hazard","Surface.coatings",  "NM.Hazard","Surface.reactivity", "NM.Hazard", 
                                                   
                                                   "Aggregation", "NM.Hazard",   "Particle.size", "NM.Hazard", 
                                                   
                                                   "Administration.route","NM.Hazard",    "Study.type","NM.Hazard",
                                                   
                                                   "Nanoparticle","Shape", 
                                                   
                                                   "Nanoparticle", "Surface.reactivity",  "Nanoparticle", "Dissolution",
                                                   
                                                   "Nanoparticle", "Surface.coatings","Nanoparticle", "Surface.charge",
                                                   
                                                   "Nanoparticle", "Administration.route", 
